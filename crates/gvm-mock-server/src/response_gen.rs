...
pub static COMMAND_COVERAGE: &[CommandCoverage] = &[
    ...
    stateful_since("delete_agent", GmpVersion::V22_8),
    ...
    fixture_since("get_agent_installer_instruction", GmpVersion::V22_8),
    fixture_since("get_agent_support_bundle", GmpVersion::V22_8),
    stateful_since("get_agents", GmpVersion::V22_8),
    ...
    fixture("help"),
    stateful_since("modify_agent", GmpVersion::V22_8),
    stateful_since("modify_agent_control_scan_config", GmpVersion::V22_8),
    ...
    stateful_since("modify_credential_store", GmpVersion::V22_8),
    ...
    stateful("start_task"),
    stateful("stop_task"),
    stateful_since("sync_agents", GmpVersion::V22_8),
