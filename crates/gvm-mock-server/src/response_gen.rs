...
pub use gvm_gmp::capabilities::{
    CommandCapability as CommandCoverage, MockSupport as CommandSupport,
    COMMAND_CAPABILITIES as COMMAND_COVERAGE, COMMAND_NAMES as KNOWN_COMMANDS,
};
...
pub fn is_known_command(name: &str) -> bool {
    gvm_gmp::capabilities::is_known_command(name)
}
